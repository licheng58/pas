    ...
    <div class="rk-error-log-bar flex-h">
      <div class="flex-h bar-selectors">
        ...
        <CommonSelector :hasSearch="true"
                        ...
                        icon="code" />
        <CommonSelector v-if="logState.type.key === cateGoryBrowser"
                        :hasSearch="true"
      ...
      <span class="flex-h rk-right">
        <a class="rk-log-search-btn bg-blue mr-10"
           @click="openConditionsBox">
          <rk-icon icon="settings"
                   class="mr-5" />
        ...
        <a class="rk-log-clear-btn r mr-10"
           @click="clearSearch">
          <rk-icon icon="clear"
                   class="mr-5" />
