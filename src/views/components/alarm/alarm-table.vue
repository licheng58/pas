  ...
  <div class="rk-timeline-table clear">
    <div v-for="(i, index) in data"
      ...
      <div class="rk-timeline-table-i g-sm-9">
        ...
        <div class="rk-timeline-table-i-scope mr-10 l sm"
             :class="{
      ...
      <div class="mb-10 clear rk-flex"
        ...
        <template>
          ...
          <span v-else-if="item.label === 'tags'">
            <div v-for="(d, index) in alarmTags"
                 :key="index">{{ d }}</div>
          </span>
          <span v-else-if="item.label === 'events'"
            ...
            <div>
              <ul>
                <li>
                  <span v-for="(i, index) of eventsHeaders"
                        :class="i.class"
                        :key="i.class + index">
                    {{ $t(i.text) }}
                  </span>
                ...
                <li v-for="event in currentEvents"
                  ...
                  <span v-for="(d, index) of eventsHeaders"
                        :class="d.class"
                ...
                <div class="event-detail">
                  <div class="mb-10 rk-flex"
                    ...
                    <span v-if="eventKey.class === 'parameters'">
                      <span v-for="(d, index) of currentEvent[d.class]"
                            :key="index">{{ d.key }}={{ d.value }}; </span>
                    </span>
