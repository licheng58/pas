  ...
  <div class="rk-topo-instance-dependency">
    <div class="rk-dependency-chart">
      <DependencySankey :data="stateTopo.instanceDependency"
                        @showMetrics="showDependencyMetrics" />
      ...
      <div v-if="stateTopo.selectedInstanceCall"
        ...
        <div class="mb-5 clear header">
          ...
          <span class="topo-tool-btn"
            ...
            <input id="instance-tool-bar-file"
                   type="file"
                   name="file"
                   title=""
                   accept=".json"
          ...
          <span class="topo-tool-btn"
                @click="exportTopoInstanceDependencyMetrics">
            <rk-icon class="lg"
                     icon="save_alt"
        ...
        <div v-if="stateTopo.selectedInstanceCall"
          ...
          <DashboardItem v-for="(i, index) in serviceInstanceDependencyComps || []"
                         :key="i.uuid"
