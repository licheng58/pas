...
<template>
  <div v-if="stateTopo.selectedServiceCall || showServerInfo"
    ...
    <svg :style="`position:absolute;left:-48px;top:0;transform: rotate(${isMini ? 0 : 180}deg);`"
    ...
    <div class="mb-5 clear flex-h">
      <span class="tool-title"
            v-if="stateTopo.selectedServiceCall">
      ...
      <span v-else-if="showServerInfo"
            class="b dib vm tool-title">{{ $t('serviceDetail') }}</span>
      <div class="flex-h">
        <div class="topo-tool-btn"
             @click="handleSetEdit">
        ...
        <div class="topo-tool-btn"
             @click="exportTopoServiceMetrics">
          <rk-icon class="lg"
                   icon="save_alt"
    ...
    <div v-if="showInfo">
      ...
      <TopoServiceDependency v-if="stateTopo.selectedServiceCall"
                             ...
                             ref="serviceDependency" />
      <TopoServiceMetrics v-else-if="showServerInfo"
                          :currentType="currentType"
                          ref="serviceTemplate" />
    </div>
    <div class="show-dependency"
         v-if="stateTopo.selectedServiceCall">
      <a class="rk-btn lg"
         @click="openInstanceModal">{{ $t('ShowInstanceDependency') }}</a>
      <rk-sidebox class="instance-dependency"
                  width="100%"
                  :fixed="false"
                  :title="
