...
<template>
  <div :class="`${pre}`">
    <div :class="`${pre}-head`">
      ...
      <a :class="`${pre}-next-month-btn`"
         v-show="!showYears && !showMonths"
         @click="nm">
        <svg class="icon lg cp">
          <use xlink:href="#chevron-right"></use>
        </svg></a>
      <a :class="`${pre}-next-year-btn`"
         v-show="!showYears"
         @click="year++"><svg class="icon sm cp">
          <use xlink:href="#angle-double-right"></use>
        </svg></a>
      <a :class="`${pre}-next-decade-btn`"
         v-show="showYears"
    ...
    <div :class="`${pre}-body`">
      ...
      <div :class="`${pre}-hours scroll_hide`"
           v-show="showHours">
