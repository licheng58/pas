      ...
      <div class="datepicker-popup"
        ...
        <template v-if="range">
          ...
          <div class="datepicker-popup__body">
            <rk-calendar v-model="dates[0]"
                         :left="true"></rk-calendar>
            <rk-calendar v-model="dates[1]"
                         :right="true"></rk-calendar>
          </div>
        </template>
        <template v-else>
        ...
        <div v-if="showButtons"
             class="datepicker__buttons">
          <button @click.prevent.stop="cancel"
                  class="datepicker__button-cancel">
            {{ this.local.cancelTip }}
          </button>
          <button @click.prevent.stop="submit"
